...
ggplot(data=f, aes(x=cosBAH, y=AHdist^3)) + plot_parts +
...
#	ggplot(data=sub_f, aes(x=cosBAH, y=AHdist^3)) + plot_parts +
#		scale_x_cosBAH + scale_y_AHdist3 +

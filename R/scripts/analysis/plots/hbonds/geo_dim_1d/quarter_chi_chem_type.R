...
table_id <- "hbond_sp2_quarter_chi_statistics"
...
table_id <- "hbond_sp2_quarter_chi_chem_type_statistics"
table_title <- "H-Bond BA-Chi Out of Sp2 plane Summary Statistics, SeqSep > 5, B-Factor < 30"
save_tables(self,
	stats, table_id,
	sample_sources, output_dir, output_formats,
...
table_id <- "hbond_sp2_quarter_chi_don_chem_type_statistics"
table_title <- "H-Bond BA-Chi Out of Sp2 plane Summary Statistics, SeqSep > 5, B-Factor < 30"
save_tables(self,
	stats, table_id,
	sample_sources, output_dir, output_formats,
...
table_id <- "hbond_sp2_quarter_chi_acc_chem_type_statistics"
table_title <- "H-Bond BA-Chi Out of Sp2 plane Summary Statistics, SeqSep > 5, B-Factor < 30"
save_tables(self,
	stats, table_id,
	sample_sources, output_dir, output_formats,

...
DROP TABLE antiparallel_AHdists;
DROP TABLE parallel_AHdists;"
...
#  geom_indicator(data=dp, aes(indicator=counts, colour=sample_source, group=sample_source)) +
#	geom_line(data=dap, aes(x=x, y=y, colour=sample_source)) +
#  geom_indicator(data=dap, aes(indicator=counts, colour=sample_source, xpos="left", group=sample_source)) +
